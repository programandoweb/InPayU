...
const ResponsiveAppBar  =   (props) => {
  ...
  return (
    <HideOnScroll {...props}>
      <AppBar color="secondary" variant="jorge">
            ...
            <Box sx={{ flexGrow: 0 }}>
              ...
              >
                {menu_user.map((setting,key) =>{
                    if (setting.menu && !setting.private && !context.user && (!setting.items || (setting.items && setting.items.length===0))) {
                      return <MenuItem  key={key}
                                        component={Link}
                    ...
                    }else if (setting.menu && setting.private && context.user && (!setting.items || (setting.items && setting.items.length===0))) {
